#line 1 "D:\\stm32_trial\\User\\timer_key\\timer_key.c"
#line 1 "D:\\stm32_trial\\User\\timer_key\\timer_key.h"
...
#line 10 "D:\\stm32_trial\\User\\timer_key\\timer_key.h"
...
#line 2 "D:\\stm32_trial\\User\\timer_key\\timer_key.c"
...
void key_exti_init(void)
{
    ...
    RCC_APB1PeriphClockCmd(((uint32_t)0x00000002), DISABLE);	    
...
void key_exti_sacn(void)
{
    ...
    switch (KeyState)
    {
        ...
        case  KEY_RELEASE:
            if (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001)) == 1)                                           
                { 
                    KeyState =  KEY_CHECK;    
                }
                break;
