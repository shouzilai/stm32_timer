#line 1 "D:\\stm32_trial\\User\\main.c"
...
#line 1 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 29 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 30 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 31 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 32 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 33 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 34 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 35 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 36 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 37 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 38 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 39 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 40 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 41 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 42 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 43 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 44 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 45 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 46 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 47 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 48 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 49 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 50 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 51 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 74 "D:\\stm32_trial\\User\\stm32f10x_conf.h"
...
#line 2 "D:\\stm32_trial\\User\\main.c"
#line 1 "D:\\stm32_trial\\User\\led/led.h"




#line 1 "D:\\stm32_trial\\User\\led/led.h"
#line 7 "D:\\stm32_trial\\User\\led/led.h"
#line 1 "D:\\stm32_trial\\User\\common.h"
...
#line 8 "D:\\stm32_trial\\User\\led/led.h"
...
void set_timer_config(int c_times);

#line 3 "D:\\stm32_trial\\User\\main.c"
#line 1 "D:\\stm32_trial\\User\\key/key.h"
...
#line 4 "D:\\stm32_trial\\User\\main.c"
#line 1 "D:\\stm32_trial\\Project\\..\\User\\exti\\exti.h"
...
#line 5 "D:\\stm32_trial\\User\\main.c"
#line 1 "D:\\stm32_trial\\User\\timer/timer.h"
...
#line 6 "D:\\stm32_trial\\User\\main.c"
#line 1 "D:\\stm32_trial\\User\\timer_key/timer_key.h"
...
void key_exti_sacn(void);


#line 7 "D:\\stm32_trial\\User\\main.c"
...
int main()
{
    led_config_init(((uint32_t)0x00000010), ((uint16_t)0x2000), GPIO_Mode_Out_PP, GPIO_Speed_50MHz, ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)));
    key_config_init(((uint32_t)0x00000004), ((uint16_t)0x0001), GPIO_Mode_IPU, ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)));
    key_exti_init();
    
    RCC_APB1PeriphClockCmd(((uint32_t)0x00000002), ENABLE);TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ENABLE);	                         
    ...
    {   
        ...
        switch(g_KeyActionFlag)
        {
            case SHORT_KEY:
                ...
                GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));;
                if (short_count == 0) {
                    TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), DISABLE);RCC_APB1PeriphClockCmd(((uint32_t)0x00000001), DISABLE);
                    time=0;RCC_APB1PeriphClockCmd(((uint32_t)0x00000001), ENABLE);TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ENABLE);
                    
                    set_timer_config(120);
                    printf("slowly\n");
                } else {
                    TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), DISABLE);RCC_APB1PeriphClockCmd(((uint32_t)0x00000001), DISABLE);
                    time=0;RCC_APB1PeriphClockCmd(((uint32_t)0x00000001), ENABLE);TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ENABLE);
...
int main_timer_led(void)
{
    ...
    while(1)
    {
        ...
        if ( time >= 50 )  
        {
            time = 0;
            printf("time on %d\n", time);
            GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000), (BitAction)((1 - GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000)))));   
        }
    }
    return 0;
}
...
int main_exti_key(void)
{
    ...
    uint32_t rcc_integration = ((uint32_t)0x00000010);
    GPIO_TypeDef *gpiox_integration = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000));
...
int main_key(void)
{
    ...
    led_config_init(((uint32_t)0x00000010), ((uint16_t)0x2000), GPIO_Mode_Out_PP, GPIO_Speed_50MHz, ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)));
    if(0) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));

     
    key_config_init(((uint32_t)0x00000004), ((uint16_t)0x0001), GPIO_Mode_IPU, ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)));

    while (1) {
        if (Key_Scan(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001)) == 0) {
...
int main_led(void)
{
    ...
    while (1) {
        ...
        if(0) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));	
        Delay(0x0FFFEF);
        if(1) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x2000));	
