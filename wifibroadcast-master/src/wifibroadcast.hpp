...
static uint8_t ieee80211_header_rts[] __attribute__((unused)) = {
    0xB4,                                 // Subtype 1011 Type 01 Version 00
    0x00,                                 // Frame control flags
    0xA0, 0x00,                           // Duration
    0x57, 0x42, 0xaa, 0xbb, 0xcc, 0xdd,   // last four bytes will be replaced by channel_id
    0x57, 0x42, 0xaa, 0xbb, 0xcc, 0xdd,   // last four bytes will be replaced by channel_id
};

static uint8_t ieee80211_header_cts[] __attribute__((unused)) = {
    0xC4,                                 // Subtype 1100 Type 01 Version 00
    0x00,                                 // Frame control flags
    0x74, 0x00,                           // Duration
    0x57, 0x42, 0xaa, 0xbb, 0xcc, 0xdd,   // last four bytes will be replaced by channel_id
    0x57, 0x42, 0xaa, 0xbb, 0xcc, 0xdd,   // last four bytes will be replaced by channel_id
